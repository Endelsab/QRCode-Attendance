						...
						<form onSubmit={(e) => e.preventDefault()}>
							<div className="grid w-full gap-4">
								{[
									...
									{ label: "Course/Year", name: "courseYear", type: "text" },
									{ label: "Student ID", name: "studentId", type: "text" },
									{ label: "Parent's Name", name: "parentsName", type: "text" },
									{ label: "Parent's Email", name: "email", type: "email" },
								].map(({ label, name, type }) => (
					...
					<div>
						<div className="flex flex-col h-[280px] justify-center items-center mt-4">
							<div className="p-4 rounded-lg">
								{showQRCode && <QRCode value={formData.studentId} />}
							</div>
						</div>
